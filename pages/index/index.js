...
var GetList = function (that) {
  wx.request({
    url: app.globalData.https + 'index.php/Home/XiaoActivity/activity',
    data: {
      page: that.data.page,
  ...
  data: {
    ...
    adUrl:''
        ...
        wx.getSystemInfo({
          ...
          //获取广告图文信息（轮播图）
           wx.request({
             url: 'https://m.xxiangfang.com/index.php/Home/Xiaoxxf/adshop',//上线的话必须是https，没有appId的本地请求貌似不受影响  
             data: {},
             method: 'GET', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT  
             // header: {}, // 设置请求的 header  
             header: {
         ...
         var that = this;
         wx.request({
           url: 'https://m.xxiangfang.com/index.php/Home/Xiaoxxf/adUrl',
           data: {
           },
           success: function (res) {
             that.data.adUrl = res.data;
           }
         });
         GetList(that);
